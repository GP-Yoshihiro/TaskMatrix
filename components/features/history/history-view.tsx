...
import { HistoryDiff } from '@/components/features/history/history-diff'
import { HistoryList } from '@/components/features/history/history-list'
import { HistorySearch } from '@/components/features/history/history-search'
 ...
 * 変更履歴の画面全体。
 *
 * 左に一覧、右に差分を置き、境界をドラッグして比率を変えられる。
 * 変えた比率は記憶して以降も適用する。
 */
